...
# Edited by VOLKAN TA2KVC
# Edited deprecated wiringpi2 library to wiringpi library, added wiringpi setup code and relay code TA2KVC 
# www.astrorats.org | @_tin0_

import wiringpi

wiringpi2 = wiringpi  # Edited by VOLKAN TA2KVC
wiringpi.wiringPiSetup() # Edited by VOLKAN TA2KVC

data_pin  = 5 # data line (pin 6 on the module)
clock_pin = 6 # clock line (pin 7 on module)
relaypin = 4 # Edited by VOLKAN TA2KVC 2n2222 transistor role icin pin
...
# Edited by VOLKAN TA2KVC 
# Role acik / kapali kodlari
def RelayOn():
  wiringpi2.pinMode(relaypin,1)
  wiringpi2.digitalWrite(relaypin,1)
  wiringpi2.delay(500)

def RelayOff():
  wiringpi2.digitalWrite(relaypin,0)
  wiringpi2.pinMode(relaypin,0)
  wiringpi2.delay(500)
